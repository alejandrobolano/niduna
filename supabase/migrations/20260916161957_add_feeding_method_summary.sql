drop function public.get_care_range_summary(uuid, timestamptz, timestamptz);
...
returns table (
  ...
  feeding_breast_count bigint,
  feeding_expressed_milk_count bigint,
  feeding_formula_count bigint,
  feeding_mixed_count bigint,
...
begin
  ...
  feeding_summary as (
    select
      ...
      count(*) filter (
        where ordered_feedings.feeding_method = 'breast'
      )::bigint as breast_count,
      count(*) filter (
        where ordered_feedings.feeding_method = 'expressed_milk'
      )::bigint as expressed_milk_count,
      count(*) filter (
        where ordered_feedings.feeding_method = 'formula'
      )::bigint as formula_count,
      count(*) filter (
        where ordered_feedings.feeding_method = 'mixed'
  ...
  select
    ...
    feeding_summary.breast_count,
    feeding_summary.expressed_milk_count,
    feeding_summary.formula_count,
    feeding_summary.mixed_count,
